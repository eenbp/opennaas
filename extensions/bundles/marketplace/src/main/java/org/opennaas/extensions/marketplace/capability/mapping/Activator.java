...
public class Activator extends AbstractActivator implements BundleActivator {
	 ...
	 * @throws ActivatorException
	 */
	public static IActionSet getMappingActionSetService(String name, String version) throws ActivatorException {

		try {
			log.debug("Calling MappingActionSetService");
			return (IActionSet) getServiceFromRegistry(context, createFilterMappingActionSet(name, version));
		} catch (InvalidSyntaxException e) {
			throw new ActivatorException(e);
		}
	}
	 ...
	 * @throws InvalidSyntaxException
	 */
	private static Filter createFilterMappingActionSet(String name, String version) throws InvalidSyntaxException {

		Properties properties = new Properties();
		properties.setProperty(ResourceDescriptorConstants.ACTION_CAPABILITY, "mapping");
